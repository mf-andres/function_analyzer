...
def do_addition(function_string: str) -> str:
    ...
    left_operand = find_left_operand(function_string, addition_sign_position)
    right_operand = find_right_operand(function_string, addition_sign_position)
...
def find_left_operand(function_string, sign_position) -> int:  # TODO duplicity
...
def find_right_operand(function_string, sign_position) -> int:
...
def substitute_operation_for_partial_result(function_string,
                                            ...
                                            right_operand_position,
                                            partial_result):
    operation_to_be_replaced = function_string[left_operand_position, right_operand_position]
    function_string = function_string.replace(operation_to_be_replaced, partial_result)
    return function_string