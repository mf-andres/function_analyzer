...
class SignFinder:
    ...
    @staticmethod
    def get_string_position_from_left_substring_position(
        first_sign_position_in_reversed_left_substring, sign_position
    ):
        left_sign_or_end_position = (
            sign_position - 1 - first_sign_position_in_reversed_left_substring
        )
        return left_sign_or_end_position

    @staticmethod
    def get_string_position_from_right_substring_position(
        first_sign_position_in_right_substring, sign_position
    ):
        right_sign_or_end_position = (
            sign_position + 1 + first_sign_position_in_right_substring
        )
