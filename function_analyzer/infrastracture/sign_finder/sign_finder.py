...
def find_right_sign_or_end_position(function_string, sign_position):
    ...
    if contains_sign(right_substring):
        ...
        right_sign_position = get_string_position_from_red_substring_position(
...
def get_string_position_from_red_substring_position(first_sign_position_in_right_substring, sign_position):
