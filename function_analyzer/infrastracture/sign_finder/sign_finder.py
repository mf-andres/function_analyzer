...
class SignFinder:
    ...
    def find_left_sign_or_end_position(function_string, sign_position):
        ...
        if Sign.contains_sign(left_substring):
            ...
            first_sign_position_in_reversed_left_substring = SignFinder.find_first_sign_position_in_string(reversed_left_substring)
    ...
    def find_right_sign_or_end_position(function_string, sign_position):
        ...
        if Sign.contains_sign(right_substring):
            first_sign_position_in_right_substring = SignFinder.find_first_sign_position_in_string(right_substring)
