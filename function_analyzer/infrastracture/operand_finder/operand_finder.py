...
class OperandFinder:
    ...
    def find_left_operand_position(function_string, sign_position):
        left_sign_or_end_position = SignFinder.find_left_sign_or_end_position(function_string, sign_position)
    ...
    def find_right_operand_tail(function_string, sign_position):
        right_sign_or_end_position = SignFinder.find_right_sign_or_end_position(function_string, sign_position)
