...
def test_calculate_shift_length():
    ...
    partial_result = "123"
    returned_shift_length = Operation.calculate_shift_length(
...
def test_substitute_operands_and_operation_for_partial_result():
    ...
    right_operand = Operand(
        right_operand_position, right_operand_string, right_operand_tail
    )

    partial_result = "3"

    returned_function_string = Operation.substitute_operation_for_partial_result(
        function_string, left_operand, right_operand, partial_result
    )
