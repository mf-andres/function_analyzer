...
def test_find_left_sign_or_end_position_for_sum_operand():
    ...
    sign_position = 3
    returned_left_sign_or_end_position = SignFinder.find_left_sign_or_end_position(function_string, sign_position)
...
def test_find_right_sign_or_end_position_for_sum_operand():
    ...
    sign_position = 1
    returned_right_sign_or_end_position = SignFinder.find_right_sign_or_end_position(function_string, sign_position)
